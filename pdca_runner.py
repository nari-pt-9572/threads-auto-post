...
【タイトルのルール】
・読んだ人が「どういうこと？」と続きを読みたくなる逆説・カウンター表現
・例：「動いてから気づいたこと。」「PTが副業を始めた理由。」「怖かったけど動いた話。」「職場には言ってない。」「怪しいと思ってた。」「副業、最初は信じてなかった。」「正直、怪しいと思った。」「月収100万はいらない。」「案件を断り続けた話。」「勧誘に疲れた頃の話。」「怪しいは、正解だった。」「老後より今が怖かった。」「続けられた理由、それだけ。」「一歩が怖かった、だけ。」
・主語が曖昧になるタイトルはNG（例：「怪しい人、見抜けた。」→「怪しい人を見抜いた」と誤読される）
・タイトル単体で意味が完結して正確に伝わること
・毎回違うバリエーションにする
・20文字以内。句読点で終わる。タイトルのみ返す（説明不要）"""
    else:

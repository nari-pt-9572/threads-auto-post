...
- 1行目は0.5秒でスクロールを止めるフック
  → 具体的な数字・場所・状況・行動・セリフのどれか1つで始める
  → 「財布に〇〇円しか」で始めるのは禁止（使いすぎ）
  → 「割り勘にしてもらった〜」「3年目の昇給〜」「彼女から〜」「〇〇円だった頃」など毎回違うパターンで始める
  → 説明しすぎない・語らなすぎない
  → 読んだ人が「...どういうこと？」と思って次の行に進む一言
- 感情は説明せず、場面と行動で伝える
- 前後の因果関係を通す（「〜した→でも〜だった」のように矛盾する展開はNG）
- 読んだ人が「で、結局どうなったの？」と混乱しないストーリーにする
- セリフを使う場合、そのセリフが感情や状況を深めるものだけ使う（意味のない会話シーンはNG）
- 感情は行動で見せる（「返信できなかった」「黙って運転してた」「棚の前に30分立ってた」）
- 金額のリアリティを守る：財布に数百円・1000円台は社会人としてあり得ないのでNG。「高速代を払ったら食費が苦しい」「口座残高が月末にギリギリ」くらいの温度感が正しい
- 遠距離（片道3時間）の設定を守る：「今夜会いに行く」「今夜は会えない」など近距離前提の表現はNG

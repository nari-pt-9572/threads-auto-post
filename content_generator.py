...
M. アパレル物販・環境の話（興味喚起）
　ポイント：日本では毎年大量の衣服が廃棄されている。有名ブランドが在庫を燃やすという話が問題になったこともある。捨てられる予定だった服が、誰かの手に渡ることで価値が生まれる。僕がアパレルの物販を選んだのはそういう仕組みがあったから。稼ぎながら廃棄を減らせる、というのが自分の中で一番納得できた理由だった。仕入れ値・売値・利益などの数字やプラットフォーム名は言わない。

N. アパレル物販・怪しくない理由（信頼構築）
　ポイント：副業というと怪しいと思われる。でも廃棄される予定のアパレルが、適切な価格で誰かの手に渡るなら、それはただの転売じゃない。社会の問題を小さく解決しながら収入を得る感覚。月収100万を目指してるわけじゃない。本業以外の収入の柱を持ちたかっただけ。仕入れ値・売値などの数字やプラットフォーム名は言わない。

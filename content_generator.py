...
- 本業と副業を両立して気づいたこと
- 「副業って怪しい」と思っていた頃の話（始める前は自分もそう思っていた、でも実際動いてみたら〜という展開）
- 利益優先で案件を押し付けてくる人たちへの不信感・疲れ（「自分の状況も聞かずに案件を勧めてくる」「月収100万とか言われても別にそれは求めてない」という本音。でもお金が必要な現実は変わらないから、自分に合うものを自分で探した、という展開）

【ルール】
・1文1行、一人称は「僕」、丁寧語NG
・副業の内容・手法・具体的な金額は言わない
・「動いたらどう変わったか」「気づいたこと」を描写する
・「怪しい」「案件押し付け」切り口の場合：読者の疑いや不信感を先に代弁し、自分の体験で静かに裏切る構成にする
・「月収100万」「起業」などの大げさな勧誘と距離を置き、普通の人間として等身大に語る
・最後の一行は抽象的な気づきで締める
・100〜140文字
・絵文字・ハッシュタグなし

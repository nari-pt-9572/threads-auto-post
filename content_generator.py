...
・押しつけがましくならないトーンで""",
    ...
    5: """【シリーズ⑥：副業が怖い人への背中押し】
「副業は怖い」という人に向けて共感しながら一歩を後押しする投稿を書いてください。

ポイント：
・好きなことだけしたい、将来の不安もある、でも副業は怖い——その気持ちはわかる
・昔の自分と同じ気持ちの人がかなり多いと実感してる
・友人にも、DMでも、同じ悩みをよく聞く
・理学療法士に限らず、今の日本で「今のままで大丈夫」と言える人の方が少ない
・だからこそ少しずつでも対策していく必要があると思う
・「怖いのは当然だけど、何もしないことの方が怖い」という締め
・押しつけがましくならない等身大のトーンで""",

    6: """【シリーズ⑦：副業って不安な方へのCTA】
「副業って不安...」と感じている人に向けて、自分の経験を共有しながらDMに誘導する投稿を書いてください。

ポイント：
・最初は「本当に稼げるの？」「騙されたらどうしよう」そんな不安だらけだった
・自分も同じ気持ちだったから、その不安はよくわかる
・でも自分に合った収入の上げ方で、しっかり続けられてる
・一歩踏み出したいと思ってる人は、今の状況や目的をDMで教えてほしい
・何をやればいいか押しつけるんじゃなく、まず話を聞きたいというスタンスで
・最後はDM誘導で締める（「ぜひ聞かせてください」程度の柔らかい表現）""",

    7: """【シリーズ⑧：職場が副業禁止の方へ】
「職場が副業禁止だから自分には無理」と思っている人に向けて、誤解を解く投稿を書いてください。

ポイント：
・会社が禁止しているのは「他の会社に雇われて働くこと（＝アルバイト）」がほとんど
・個人で収入を得る形であれば問題ないケースがほとんど
・税金の手続きをきちんとすれば会社に副業がバレる心配もない
・「副業NGだから無理かも」と諦める前に、まず気軽に相談してほしい
・ただし公務員は法律で原則副業NGである点には正直に言及する
・「制度を正しく知った上で判断してほしい」という誠実なトーンで""",
}


def get_fukugyo_series_position(posts_log: list) -> int:
    """副業投稿の現在のシリーズ位置（0〜7）を返す"""
    fukugyo_count = sum(1 for p in posts_log if p.get("post_type") == "fukugyo")
    return fukugyo_count % 8
...
【共通ルール】
・1文1行、一人称は「僕」、丁寧語NG
・文末は「〜た」「〜てる」「〜ない」で統一。「〜だよ」「〜よな」「〜じゃん」などの口語終わりはNG
・読み手に直接語りかけるスタイル（「〜よな」「〜でしょ」「そんな方へ」）はNG。内面の気持ちや経験を独白スタイルで書く
・DM誘導が必要なシリーズは最後の1〜2行だけ「〜聞かせてほしい」「〜話してほしい」程度の柔らかい表現にとどめる

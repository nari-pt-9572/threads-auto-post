...
【切り口（毎回ランダムに選ぶ）】
A. 副業を始める前の迷い・怖さ（最初の一歩が怖くて動けなかった、という共感）
B. 最初の一歩を踏み出した瞬間（怖かったけど動いたら変わった）
C. 副業後に彼女との関係が変わった話
D. 副業について職場や友人に聞かれたときの話
E. 本業と副業を両立して気づいたこと
F. 「副業って怪しい」という感覚は実は正しかった、という切り口（世の中の副業が怪しく見える理由が分かった。でも怪しくないものもある。という展開）
G. 利益優先で案件を押し付けてくる人たちへの不信感・疲れ（自分の状況も聞かずに勧めてくる、月収100万とか起業とか別にそれは求めてない、という本音。でもお金が必要な現実は変わらない、という展開）
H. 老後のお金問題に気づいた話（年金が減る現実、老後に必要なお金、でも本業だけじゃ不安、だから動いた、という展開）
I. 自分に合ったやり方で続けられた話（月収100万ではなく、自分のペースで少しずつ成果が出た）
